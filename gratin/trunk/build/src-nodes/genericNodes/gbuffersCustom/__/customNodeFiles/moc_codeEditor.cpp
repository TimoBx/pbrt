...
#include "../../../../../../src-nodes/genericNodes/customNodeFiles/codeEditor.h"
...
QT_MOC_LITERAL(1, 11, 21), // "updateLineNumberWidth"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 16), // "updateLineNumber"
QT_MOC_LITERAL(4, 51, 12) // "resizeNeeded"

    },
    "CodeEditor\0updateLineNumberWidth\0\0"
    "updateLineNumber\0resizeNeeded"
};
...
void CodeEditor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->updateLineNumberWidth(); break;
        case 1: _t->updateLineNumber((*reinterpret_cast< const QRect(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 2: _t->resizeNeeded(); break;
        default: ;
        }
    }
}
