...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_GridCustomWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_GridCustomWidget_t qt_meta_stringdata_GridCustomWidget = {
    {
QT_MOC_LITERAL(0, 0, 16), // "GridCustomWidget"
QT_MOC_LITERAL(1, 17, 16), // "gridDepthChanged"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 14) // "defaultClicked"
...
const QMetaObject GridCustomWidget::staticMetaObject = {
    { &GenericCustomWidget::staticMetaObject, qt_meta_stringdata_GridCustomWidget.data,
      qt_meta_data_GridCustomWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *GridCustomWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_GridCustomWidget.stringdata0))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_GridCustomHandle_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_GridCustomHandle_t qt_meta_stringdata_GridCustomHandle = {
    {
QT_MOC_LITERAL(0, 0, 16) // "GridCustomHandle"
...
const QMetaObject GridCustomHandle::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_GridCustomHandle.data,
      qt_meta_data_GridCustomHandle,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_GridCustomHandle.stringdata0))
...
static const unsigned char qt_pluginMetaData[] = {
    ...
    0x11, 0x00, 'G',  'r',  'a',  't',  'i',  'n', 
    '.',  'G',  'r',  'i',  'd',  'C',  'u',  's', 
    't',  'o',  'm',  0x00, 0x9b, 0x07, 0x00, 0x00,
    0x09, 0x00, 'c',  'l',  'a',  's',  's',  'N', 
    'a',  'm',  'e',  0x00, 0x10, 0x00, 'G',  'r', 
    'i',  'd',  'C',  'u',  's',  't',  'o',  'm', 
...
static const unsigned char qt_pluginMetaData[] = {
    ...
    0x11, 0x00, 'G',  'r',  'a',  't',  'i',  'n', 
    '.',  'G',  'r',  'i',  'd',  'C',  'u',  's', 
    't',  'o',  'm',  0x00, 0x95, 0x07, 0x00, 0x00,
    0x08, 0x00, 'M',  'e',  't',  'a',  'D',  'a', 
    't',  'a',  0x00, 0x00, 0x0c, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x1b, 0x0b, 0x00, 0x00, 0x09, 0x00, 'c',  'l', 
    'a',  's',  's',  'N',  'a',  'm',  'e',  0x00,
    0x10, 0x00, 'G',  'r',  'i',  'd',  'C',  'u', 
    's',  't',  'o',  'm',  'H',  'a',  'n',  'd', 
