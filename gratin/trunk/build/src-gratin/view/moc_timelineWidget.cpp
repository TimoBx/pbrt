...
#include "../../../src-gratin/view/timelineWidget.h"
...
const QMetaObject TimelineWidget::staticMetaObject = {
    { &QGraphicsView::staticMetaObject, qt_meta_stringdata_TimelineWidget.data,
...
void *TimelineWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "IOData"))
        return static_cast< IOData*>(const_cast< TimelineWidget*>(this));
