...
#include "../../../src-gratin/misc/glwindow.h"
...
QT_MOC_LITERAL(1, 9, 9), // "renderNow"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 11) // "renderLater"

    },
    "GlWindow\0renderNow\0\0renderLater"
};
...
const QMetaObject GlWindow::staticMetaObject = {
    { &QWindow::staticMetaObject, qt_meta_stringdata_GlWindow.data,
...
void *GlWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "GlContext"))
        return static_cast< GlContext*>(const_cast< GlWindow*>(this));
