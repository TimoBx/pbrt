/****************************************************************************
** Meta object code from reading C++ file 'textureIO.h'
**
...
#include "../../../src-gratin/core/textureIO.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'textureIO.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 14, 14), // "confirmClicked"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 13) // "cancelClicked"

    },
    "ImageSettings\0confirmClicked\0\0"
    "cancelClicked"
};
...
void ImageSettings::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ImageSettings *_t = static_cast<ImageSettings *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
