...
inline void NodeTexture2D::drawOutputs(GLenum *buff,int nbOutputs,bool needBinding,bool needUnbinding) {
  ...
  /* _glf->glVertexAttribPointer(0,2,GL_FLOAT,GL_FALSE,0,_boxesPts[0].data()); */
  /* _glf->glVertexAttribPointer(1,2,GL_FLOAT,GL_FALSE,0,_boxesCos[0].data()); */
  /* _glf->glDrawArrays(GL_TRIANGLES,0,6); */

  /* _glf->glDisableVertexAttribArray(1); */
  /* _glf->glDisableVertexAttribArray(0); */
...
inline void NodeTexture2D::drawOutputContent(const Matrix4f &mvp,const Vector2f &position,unsigned int i) {  
  ...
  /* _glf->glVertexAttribPointer(0,2,GL_FLOAT,GL_FALSE,0,boxesPts[0].data()); */
  /* _glf->glVertexAttribPointer(1,2,GL_FLOAT,GL_FALSE,0,boxesCos[0].data()); */
