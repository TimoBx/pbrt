...
MainWindow::MainWindow()
  ...
  QSurfaceFormat format = GlContext::surfaceFormat();
   ...
   _interlogWidget->setWidget(interactEmbed);//tmpWidget);
...
void MainWindow::about() {
  QString h = tr("<center><font size='12'> Gratin version 0.2</font></center><br>"
		 ...
		 "( <a href='mailto:romain.vergne@inria.fr'>romain.vergne@inria.fr</a> ): core-dev <br>"
		 "<a href='www.labri.fr/perso/barla/'>Pascal Barla</a> "
		 "( <a href='mailto:>pascal.barla@inria.fr'>pascal.barla@inria.fr</a> ): spec <br>"
		 "Gautier Ciaudo: patate-dev <br><br>"
