...
//   NodeGrouped *nodeGrouped = NULL;//_pbGraph->connexPartToNodeGrouped(node);
//   if(nodeGrouped) {
//     unselectNodeOutputs();
...
//   NodeGrouped *nodeGrouped = _pbGraph->nodeGroupedToConnexPart((NodeGrouped *)node);

//   if(!nodeGrouped) {
//     LogWidget::instance()->setText("Group extraction failed");
//     return;
//   } else {
//     _animationWidget->delParams(nodeGrouped->widget());
//     _nodeInterfaceWidget->removeWidget(nodeGrouped->widget());
//     _interactionWidget->removeNode(nodeGrouped);
