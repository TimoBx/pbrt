...
const QString PyramidCustomNode::defaultFragBody()   {
  return QObject::tr("in vec2 texcoord;\n"
		     ...
		     "\telse {\n"
		     "\t\tvec4 c1 = textureOffset(prevLevel0,texcoord,ivec2(-1,-1));\n"
		     "\t\tvec4 c2 = textureOffset(prevLevel0,texcoord,ivec2(-1, 1));\n"
		     "\t\tvec4 c3 = textureOffset(prevLevel0,texcoord,ivec2( 1,-1));\n"
		     "\t\tvec4 c4 = textureOffset(prevLevel0,texcoord,ivec2( 1, 1));\n"
