...
class GraphWidget : public QGLWidget, public IOData {
  Q_OBJECT
 ...
 public:
  ...
  GraphWidget(const QGLFormat &format=QGLFormat::defaultFormat());
  ~GraphWidget();
  ...
  inline void nodeCurveChanged(unsigned int id);
